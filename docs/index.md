...
description: "Free C++ course from beginner to advanced -- hands-on lessons with runnable code and real capstone projects. Part of a 37-course free learning library."
---

# C++ Mastery Path

A structured, module-wise C++ training program that takes you from your first
`int main()` to production-grade, master-level engineering — with runnable
...
| [Level 2 · Intermediate](level-2/index.md) | Idiomatic, STL-driven C++ | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Concurrency, RAII, patterns, databases | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.cpp`
  file and compile with `g++`/`clang++`, or paste into your IDE.
